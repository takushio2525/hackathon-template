// ProjectConfig.h — node_01 固有のピン定義と Config インスタンス（テンプレのみ）
...
inline const SyncConfig SYNC_CONFIG = {
    .intervalMs = 1000,
    .isConductor = false,  // node_01 を指揮者にする場合は true に変更
};

inline const ScoreConfig SCORE_CONFIG = {
    .bpm = 120,
    .trackIndex = 0,  // node_01 は楽譜トラック0を担当
};
