// ProjectConfig.h — node_02 固有のピン定義と Config インスタンス（テンプレのみ）
...
inline const SyncConfig SYNC_CONFIG = {
    .intervalMs = 1000,
    .isConductor = false,  // node_02 を指揮者にする場合は true に変更
};

inline const ScoreConfig SCORE_CONFIG = {
    .bpm = 120,
    .trackIndex = 1,  // node_02 は楽譜トラック0を担当
};
