// ProjectConfig.h — node_04 固有のピン定義と Config インスタンス（テンプレのみ）
...
inline const SyncConfig SYNC_CONFIG = {
    .intervalMs = 1000,
    .isConductor = false,  // node_04 を指揮者にする場合は true に変更
};

inline const ScoreConfig SCORE_CONFIG = {
    .bpm = 120,
    .trackIndex = 3,  // node_04 は楽譜トラック0を担当
};
